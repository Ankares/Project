...
class App
{
    ...
    private function bootstrap()
    {
        ...
        $connection->bind(IUserProcessing::class, static fn(ServiceProvider $sp) => $sp->make(UserModel::class));
        $connection->bind(User::class, static fn(ServiceProvider $serviceProvider) => new User(
            $serviceProvider->make(IUserProcessing::class)
        ));
    }
